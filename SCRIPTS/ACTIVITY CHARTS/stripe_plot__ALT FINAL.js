{
  ...
  let data = [];
  buildElevation(false, 'x', 'y').forEach(t => data.push(t));   // power
  buildElevation(true, 'x2', 'y2').forEach(t => data.push(t));  // hr

  chart = {
    data: data,
    layout: {
      xaxis:  { showticklabels: false, showgrid: false, zeroline: false, domain: [0, 1], anchor: 'y',  range: [0.5, maxMins + 0.5] },
      yaxis:  { showticklabels: false, showgrid: false, zeroline: false, domain: [0.52, 1] },
      xaxis2: { showticklabels: false, showgrid: false, zeroline: false, domain: [0, 1], anchor: 'y2', range: [0.5, maxMins + 0.5] },
      yaxis2: { showticklabels: false, showgrid: false, zeroline: false, domain: [0, 0.48] },
