{
  ...
  let maxMins = Math.max(
    ...
    altitude && altitude.length > 0 ? Math.ceil(altitude.length / secsPerMin) : 0
  );
  ...
  if (altitude && altitude.length > 0) {
    ...
    data.push({
      ...
      hovertemplate: '%{x}m<br>%{y:.0f} m<extra></extra>',
      xaxis: 'x3',
      yaxis: 'y3'
    });
  }
  ...
  chart = {
    ...
    layout: {
      ...
      yaxis:  { showticklabels: false, showgrid: false, zeroline: false, domain: [0.68, 1] },
      xaxis2: { showticklabels: false, showgrid: false, zeroline: false, domain: [0, 1], anchor: 'y2', range: [0.5, maxMins + 0.5] },
      yaxis2: { showticklabels: false, showgrid: false, zeroline: false, domain: [0.35, 0.665] },
      xaxis3: { showticklabels: false, showgrid: false, zeroline: false, domain: [0, 1], anchor: 'y3', range: [0.5, maxMins + 0.5] },
      yaxis3: { showticklabels: false, showgrid: false, zeroline: false, domain: [0, 0.30] },
