...

{
    ...
    sortedClusters.forEach((cluster, idx) => {
        ...
        const traceText = [
            ...
            hasOfficialSpeed && acc45Data ? `<b>🚀 AC45</b>:         ${acc45Data.acceleration.toFixed(2)} km/h/s (${acc45Data.startSpeed.toFixed(1)} → ${acc45Data.targetSpeed.toFixed(1)} km/h)` : '',
            hasOfficialSpeed && acc50Data ? `<b>🚀 AC50</b>:         ${acc50Data.acceleration.toFixed(2)} km/h/s (${acc50Data.startSpeed.toFixed(1)} → ${acc50Data.targetSpeed.toFixed(1)} km/h)` : '',
            hasOfficialSpeed && acc60Data ? `<b>🚀 AC60</b>:         ${acc60Data.acceleration.toFixed(2)} km/h/s (${acc60Data.startSpeed.toFixed(1)} → ${acc60Data.targetSpeed.toFixed(1)} km/h)` : '',
