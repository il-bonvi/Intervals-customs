...

{
   // Variabili di configurazione
    ...
    // Funzione per recuperare i dati degli stream
    ...
    // Unione di salite e gap come parte della stessa salita
...
if (vamDiff > 10) {
  ...
  vamArrow = ` ↔️ ${vamDiff.toFixed(0)} m/h`;
    ...
    // Aggiungi la traccia per l'intera salita
        traces.push({
